...
The *org-table-jump-next* & *org-table-jump-prev* commands provide a method for quickly & easily navigating and altering tables cell-by-cell. You define arbitrary jump conditions which determine the sequence of cells visited
