...
The following jump condition will add 1 to cells to the right of dates with year > 2022, and subtract 1 from cells to the right
of dates with year <= 2022. The initial (getdate) form is needed to ensure we only change cells to the right of those containing
dates.
#+BEGIN_SRC emacs-lisp
  ((getdate) & ((> (year (getdate)) 2022) (changenumber '1+ 0 1) | (changenumber '1- 0 1)))
#+END_SRC
